(function () {
    ...
    angular.module(CoreConfiguration.moduleName).directive("multiplePhoneMexicoOrganization", ["$rootScope", "GeoService", "APP_CONFIG", "$filter",
        function ($rootScope, geoService, config, $filter) {
            ...
            return {
                ...
                templateUrl: '/modules/core/views/multiple-phone-organization.mexico.client.view.html',

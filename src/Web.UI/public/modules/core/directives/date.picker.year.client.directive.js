(function () {
    ...
    angular.module(CoreConfiguration.moduleName).directive('datePickerYearTs', ["$timeout", function ($timeout) {
        return {
            restrict: 'E',
            replace: true,
            templateUrl: '/modules/core/views/date-picker-year.client.view.html',
            scope: {
                model: '=',
                change: '=',
                changeRef: '&',

# Web.UI/organizations Module - AI Context

## Purpose

The **organizations** AngularJS module handles organizations-related functionality in the MarbleLife web application.

## Structure

- **controllers/**: AngularJS controllers for organizations views
- **services/**: Data services and API communication
- **directives/**: Custom AngularJS directives (if exists)
- **views/**: HTML templates for organizations pages

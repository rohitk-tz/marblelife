(function () {
    ...
    angular.module(OrganizationsConfiguration.moduleName).directive("documentServices", ["FranchiseeService", function (franchiseeService) {

        return {
            restrict: 'E',
            templateUrl: 'modules/organizations/views/franchisee-document.client.view.html',
            scope: {
                services: '=',
                isEdit: '='
            },

(function () {
    ...
    angular.module(AuthenticationConfiguration.moduleName).controller("LoginController", ["$scope", "$state", "$rootScope", "UserAuthenticationService", "APP_CONFIG",
        function ($scope, $state, $rootScope, UserAuthenticationService, cfg) {
            ...
            function login() {
                ...
                return UserAuthenticationService.login(vm.user.userName, vm.user.password).then(function (result) {

(function () {
    'use strict';
    angular.module(SchedulerConfiguration.moduleName).directive('wysiwyg', ["$timeout", "APP_CONFIG", "SchedulerService", "Clock", "$rootScope",
        function ($timeout, config, schedulerService, clock, $rootScope) {
            return {
                template: '<div>' +
                    '<style>' +

# Web.UI/users Module - AI Context

## Purpose

The **users** AngularJS module handles users-related functionality in the MarbleLife web application.

## Structure

- **controllers/**: AngularJS controllers for users views
- **services/**: Data services and API communication
- **directives/**: Custom AngularJS directives (if exists)
- **views/**: HTML templates for users pages

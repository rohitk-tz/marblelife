...
INSERT INTO `NotificationType` (`Id`,`Title`, `Description`, `IsServiceEnabled`, `IsDeleted`) VALUES ('1','Forget Password', 'Forget Password', 1, 0);

INSERT INTO `emailtemplate` (`Id`, `NotificationTypeId`, `Title`, `Description`, `Subject`, `Body`) 
VALUES ('1', '1', 'Forget Password', 'Forget Password', 'Forget Password', 
...
INSERT INTO `NotificationType` (`Id`,`Title`, `Description`, `IsServiceEnabled`, `IsDeleted`) VALUES ('2','Send user Credential', 'Send user Credential', 1, 0);

INSERT INTO `emailtemplate` (`Id`, `NotificationTypeId`, `Title`, `Description`, `Subject`, `Body`) 
VALUES ('2', '2', 'Login Credential', 'Login Credential', 'Login Credential', 
'<!DOCTYPE html PUBLIC \\\"-//W3C//DTD XHTML 1.0 Transitional//EN\\\" \\\"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\\\">
<html xmlns=\\\"http://www.w3.org/1999/xhtml\\\"><head>    <meta http-equiv=\\\"Content-Type\\\" content=\\\"text/html; charset=utf-8\\\" />    
<title>Reset password | Maestro</title>    
<style type=\\\"text/css\\\">      

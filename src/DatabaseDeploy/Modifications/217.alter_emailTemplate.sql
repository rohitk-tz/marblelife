...
update `emailtemplate` set `Subject`='@Model.jobTypeName Rescheduled: @Model.StartDate  @Model.Time: @Model.FullName,@Model.Address: @Model.FranchiseeName' where id=28;
   ...
   <body style="background-repeat: repeat; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;">
           <div class="contentEditableContainer contentTextEditable">
               <div class="contentEditable">
                   ...
                   <br />
                   <p>
   				 This is to inform you that, you have been scheduled for   @Model.jobTypeName  to  Customer  @Model.FullName  on  @Model.StartDate at @Model.Time .
  				<br />
                       <br>
                       <br />                  
                       Regards,
   ...
   <body style="background-repeat: repeat; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;">
           <div class="contentEditableContainer contentTextEditable">
               <div class="contentEditable">
                   ...
                   <br />
                   <p>
   				 This is to inform you that, new details of   @Model.jobTypeName  for Customer  @Model.FullName  between @Model.StartDate to @Model.EndDate
  				<br />
                       <br>
                       <br />                  
                       Regards,
  ...
  <body style="background-repeat: repeat; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;">
      <div class="contentEditableContainer contentTextEditable">
          <div class="contentEditable">
              ...
              <br />
              <p>
                  This is to inform you that, today you are having a  @Model.jobTypeName  to Customer  @Model.FullName  on @Model.StartDate at @Model.Time.
                  <br />
              </p>
    ...
    <body style="background-repeat: repeat; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;">
            <div class="contentEditableContainer contentTextEditable">
                <div class="contentEditable">
                    ...
                    <br />
                    <p>
    				  This is to inform you that, your @Model.jobTypeName  to Customer  @Model.FullName is reassigned to you  for @Model.StartDate at @Model.Time 
   				<br />
                        <br>
                        <br />                  
                        Regards,

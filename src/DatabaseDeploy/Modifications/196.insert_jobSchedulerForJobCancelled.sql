...
values('28','Job Updation for Tech','Job Updation for Tech');

insert into `emailtemplate` (`Id`, `NotificationTypeId`, `Title`, `Description`, `Subject`, `Body`) 
values('28','28','Job Updation for Tech`','Job Updation for Tech','@Model.jobType Updated| @Model.FranchiseeName','<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
 ...
 <body style="background-repeat: repeat; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;">
         <div class="contentEditableContainer contentTextEditable">
             <div class="contentEditable">
                 ...
                 <br />
                 <p>
 				 This is to inform you that, new details of   @Model.jobTypeName  for Customer  @Model.FullName from   @Model.EndDate between @Model.StartDate to @Model.EndDate at  @Model.Address 
				<br />
                     <br>
                     <br />                  
                     Regards,

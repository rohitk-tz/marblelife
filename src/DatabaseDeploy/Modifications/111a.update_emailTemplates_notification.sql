     ...
     <body style="background-repeat: repeat; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;">
             <div class="contentEditableContainer contentTextEditable">
                 <div class="contentEditable">
                     <font size="3" color="#454545"><span>Dear Sir/Ma''am,</span>
                     <br>
                     <br />                   
    				  <p>
 				  Please find the list of emails synced with <b>MailChimp API</b> for the duration <b>@Model.StartDate - @Model.EndDate</b> in the attachment below.
  				  <br />
     				<br />
                     </p>
  				   Regards,
    ...
    <body style="background-repeat: repeat; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;">
            <div class="contentEditableContainer contentTextEditable">
                <div class="contentEditable">
                    ...
                    <br />
   				  <p>
 				  Please find the List of customers synced with <b>Review system</b> for the duration <b>@Model.StartDate - @Model.EndDate</b> in the attachment below.
 				   <br />
      				<br />       				   		                      
    					</p>					 
 				   Regards,

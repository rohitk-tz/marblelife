                          ...
                          <body style="background-repeat: repeat; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;">
                                  <div class="contentEditableContainer contentTextEditable">
                                      <div class="contentEditable">
                                       ...
                                       <p>
                       A new @Model.jobType is created with MARBLELIFE <sup>&reg;</sup> with Representative @Model.techNames We look forward to seeing you and assisting you with your project. <br/>Have a great day!
                                     </p>
    								 <br />
                          ...
                          <body style="background-repeat: repeat; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;">
                                  <div class="contentEditableContainer contentTextEditable">
                                      <div class="contentEditable">
                                       ...
                                       <p>
                       There is updation in your @Model.jobType which was scheduled with MARBLELIFE <sup>&reg;</sup> with Representative @Model.techNames We look forward to seeing you and assisting you with your project. <br/>Have a great day!
                                     </p>
    								 <br />
    								 <table style="border: 1px solid black;border-collapse:collapse;">
                                     <thead>

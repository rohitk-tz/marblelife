Insert into notificationtype (Id, Title, Description, IsQueuingEnabled, IsServiceEnabled, IsDeleted) Values (52, 'Signed Invoice To SalesRep', 'Signed Invoice To SalesRep', b'1', b'1', b'0');

Insert into emailtemplate (Id, NotificationTypeId, Title, Description, Subject, Body, IsDeleted, languageId, isActive)
Values (572,	52,	'Signed Invoice To SalesRep', 'Signed Invoice To SalesRep', 'Signed Invoice To SalesRep','<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

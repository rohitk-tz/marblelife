...
values('27','Job Cancelled for Tech','Job Cancelled for Tech');

insert into `emailtemplate` (`Id`, `NotificationTypeId`, `Title`, `Description`, `Subject`, `Body`) 
 values('27','27','Job Cancelled for Tech','Job Cancelled for Tech','@Model.jobType Cancelled| @Model.FranchiseeName`','<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
  ...
  <body style="background-repeat: repeat; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;">
          <div class="contentEditableContainer contentTextEditable">
              <div class="contentEditable">
                  ...
                  <br />
                  <p>
  				 This is to inform you that, your  @Model.jobTypeName  to Customer  @Model.FullName  @Model.EndDate between @Model.StartDate to @Model.EndDate is  <b>cancelled</b>.
 				<br />
                      <br>
                      <br />                  
                      Regards,

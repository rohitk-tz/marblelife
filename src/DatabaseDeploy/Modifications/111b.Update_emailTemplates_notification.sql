     ...
     <body style="background-repeat: repeat; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;">
             <div class="contentEditableContainer contentTextEditable">
                 <div class="contentEditable">
                     <font size="3" color="#454545"><span>Respected Sir/Ma''am,</span>
                     <br>
                     <br />                   
    				  <p>
 				  Please find attached the list of customer emails integrated with <b>MailChimp</b> during the period <b>@Model.StartDate - @Model.EndDate</b>.
  				  <br />
     				<br />
                     </p>
  				   Regards,
...
SET `Body`='<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <body style="background-repeat: repeat; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;">
            <div class="contentEditableContainer contentTextEditable">
                <div class="contentEditable">
                    <font color="#454545"><span>Respected @Model.FullName,</span>
                    <br>
                    <br />
   				  <p>
                 ...
                 <div class="contentEditable">
                     <font size="3" color="#454545">
   					 Respected Sir/Ma''am,<br /><br />
 							Please find attached the list of customers, who got served during the period <b>@Model.StartDate - @Model.EndDate</b>.<br /><br />
 							 Regards,<br /><br />

INSERT INTO `NotificationType` (`Id`, `Title`, `Description`, `IsServiceEnabled`, `IsDeleted`) VALUES ('3', 'Invoice Detail Notification', 'Invoice Detail Notification', 1, 0);

INSERT INTO `EmailTemplate` (`Id`, `NotificationTypeId`, `Title`, `Description`, `Subject`, `Body`) 
VALUES ('3', '3', 'Invoice Notification', 'Invoice Notification', 'Invoice Notification', 
...
<br/>                        
<p>  
The invoice for  @Model.Franchisee has been generated.                                                     
...
<span>GeneratedOn -  @Model.GeneratedOn</span>
 <br>                                                        
 <br/> 
<span>Total Payment -  @Model.TotalPayment</span>                                                       
<br>
<br/>                                                  
Thank you,                                                        
<br>                                                        

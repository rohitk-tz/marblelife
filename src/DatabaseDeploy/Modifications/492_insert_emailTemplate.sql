Insert into notificationtype (Id, Title, Description, IsQueuingEnabled, IsServiceEnabled, IsDeleted) Values (53, 'Post Job Completion Invoice To Customer', 'Post Job Completion Invoice To Customer', b'1', b'1', b'0');

Insert into emailtemplate (Id, NotificationTypeId, Title, Description, Subject, Body, IsDeleted, languageId, isActive)
Values (573,53,	'Post Job Completion Invoice To Customer', 'Post Job Completion Invoice To Customer', 'Post Job Completion Invoice To Customer','<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
 ...
 Insert into notificationtype (Id, Title, Description, IsQueuingEnabled, IsServiceEnabled, IsDeleted) Values (54, 'Post Job Feedback To Customer', 'Post Job Feedback To Customer', b'1', b'1', b'0');

Insert into emailtemplate (Id, NotificationTypeId, Title, Description, Subject, Body, IsDeleted, languageId, isActive)
Values (574,54,	'Post Job Completion Customer Invoice', 'Post Job Completion Customer Invoice', 'Post Job Completion Customer Invoice','<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
	<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<title>@Model.Base.CompanyName</title>

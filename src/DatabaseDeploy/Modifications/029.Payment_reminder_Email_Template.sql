INSERT INTO `Notificationtype` (`Id`, `Title`, `Description`, `IsServiceEnabled`, `IsDeleted`) VALUES ('4', 'Payment Reminder Notification', 'Payment Reminder Notification', 1, 0);

INSERT INTO `EmailTemplate` (`Id`, `NotificationTypeId`, `Title`, `Description`, `Subject`, `Body`) 
VALUES ('4', '4', 'Payment Reminder', 'Payment Reminder', 'Payment Reminder', 
...
<br/>                        
<p>                                                        
Your payment for Invoice# - @Model.InvoiceId was due on @Model.DueDate for Franchisee -  @Model.Franchisee .                                        
<br>                                                        
<br/>                                                        
The amount of payment is - @Model.Amount, Please make the Payment to avoid Late fee charges.
 <br>                                                        
 <br/>                                               
Thank you,                                                        
<br>                                                        

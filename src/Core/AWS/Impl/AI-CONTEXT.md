...
This folder contains the concrete implementations of service interfaces and factories for the **AWS** module. These classes contain the actual business logic.

# Application/Enum - AI Context

## Purpose

This folder contains enumeration types for the **Application** module. Enums provide type-safe constants for domain-specific values.

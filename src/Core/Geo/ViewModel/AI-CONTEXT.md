# Geo/ViewModel - AI Context

## Purpose

This folder contains Data Transfer Objects (DTOs) / ViewModels for the **Geo** module. These classes are used to transfer data between the API layer and client applications.

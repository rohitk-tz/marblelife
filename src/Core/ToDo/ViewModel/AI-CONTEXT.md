# ToDo/ViewModel - AI Context

## Purpose

This folder contains Data Transfer Objects (DTOs) / ViewModels for the **ToDo** module. These classes are used to transfer data between the API layer and client applications.

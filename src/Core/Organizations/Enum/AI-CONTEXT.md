# Organizations/Enum - AI Context

## Purpose

This folder contains enumeration types for the **Organizations** module. Enums provide type-safe constants for domain-specific values.

# Billing/Impl - AI Context

## Purpose

This folder contains the concrete implementations of service interfaces and factories for the **Billing** module. These classes contain the actual business logic.

# Reports/Impl - AI Context

## Purpose

This folder contains the concrete implementations of service interfaces and factories for the **Reports** module. These classes contain the actual business logic.

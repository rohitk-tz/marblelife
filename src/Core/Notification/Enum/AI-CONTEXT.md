# Notification/Enum - AI Context

## Purpose

This folder contains enumeration types for the **Notification** module. Enums provide type-safe constants for domain-specific values.

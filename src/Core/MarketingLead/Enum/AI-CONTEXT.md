# MarketingLead/Enum - AI Context

## Purpose

This folder contains enumeration types for the **MarketingLead** module. Enums provide type-safe constants for domain-specific values.

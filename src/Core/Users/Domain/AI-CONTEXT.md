...
This folder contains the domain entities and models for the **Users** module. These are the core business objects that represent the data structures and business concepts.
